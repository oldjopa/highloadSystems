...
-- USERS
INSERT INTO app_user (id, email, phone, hashed_password, first_name, last_name) VALUES
                                                                                    (1, 'admin@example.com', '+10000000001', 'hashed_admin', 'Admin', 'User'),
...
-- ENGINES
INSERT INTO engine (id, name, type, power) VALUES
                                               (1, 'Pratt & Whitney PT6A', 'TURBOPROP', 750.0),
...
VALUES
    (1, 'Cessna', '208B Grand Caravan', 'EX', 'Turboprop utility aircraft', 1, 1, 14, 3970, 1200, 186, true),
...
VALUES
    (1, 1500.0, 2015, 2200, 1300, 12.7, 15.9, 4.6, 'Stage 3', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- TECH PASSPORT FEATURES
INSERT INTO tech_passport_feature (tech_passport_id, feature_id) VALUES
                                                                     (1, 1),
                                                                     (1, 2),
                                                                     (1, 3)
...
VALUES
    (1, 1, 3, 'SN-123', 'RA-12345', 1500000.00, 'USD')
ON CONFLICT (id) DO NOTHING;
